...
export const metadata: Metadata = { title: "About Us", description: "Learn the story behind Rice N Rolls — fresh Korean-inspired food in Dundas, Ontario." };
...
const values = [
  ...
  { emoji:"🤝", title:"Community First", desc:"We're proud to be part of Dundas. Something for everyone on the menu!" },
];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="font-heading text-3xl sm:text-4xl font-700 text-ink mb-5">Korean Comfort Food, Dundas Home</h2>
            ...
            <div className="space-y-3 font-body text-muted leading-relaxed">
              ...
              <p>Nestled in Dundas, Ontario, we bring hand-rolled gimbap, sizzling K-pop chicken, hearty bibimbap, and more to the community — made fresh every single day.</p>
          ...
          <div className="comic-card bg-y-500 p-8 text-center">
            ...
            <p className="font-body text-body/60 text-sm mb-6">#3 2 Castlewood Blvd, Dundas ON</p>
      ...
      <section className="py-12 px-4 text-center">
        ...
        <p className="font-body text-muted mb-7 max-w-md mx-auto">Stop by or order online — we&apos;re in Dundas and ready to serve you something delicious!</p>
