...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "rice-bowl", label: "Rice Bowl", emoji: "🍚", subtitle: "Korean-style rice bowls", items: [
    { name: "Beef Bulgogi Bibimbap",           description: "Rice, carrots, cabbage, ground beef bulgogi — gochujang or sesame soya · Add fried egg +$1.50",          price: "$15.99", emoji: "🍚", image: "/images/menu/rice-bowl/beef-bulgogi-bibimbap.jpg",              tags: [],              badge: "❤️ Fan Fave" },
    { name: "Vegan Bibimbap",                  description: "Rice, carrots, seasonal herbs, cabbage, mushroom — gochujang sauce · Add fried egg +$1.50",              price: "$15.99", emoji: "🍚", image: "/images/menu/rice-bowl/vegan-bibimbap.jpg",                       tags: ["vegan","gf"] },
    { name: "Chicken Fried Rice",              description: "Rice, peas, carrot, green bean, green onion, chicken · Add fried egg +$1.50 · Add cheese +$2",                            price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/chicken-fried-rice.jpg",                   tags: [] },
    { name: "Veggie Fried Rice",               description: "Rice, peas, carrot, green bean, green onion, mushroom · Add fried egg +$1.50",                           price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/veggie-fried-rice.jpg",                    tags: ["vegan"] },
    { name: "Beef Fried Rice",                 description: "Rice, peas, carrot, green bean, green onion, beef · Add fried egg +$1.50 · Add cheese +$2",                               price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/beef-fried-rice.jpg",                      tags: [] },
    { name: "Kimchi Fried Rice",               description: "Rice, green onion, kimchi — classic Korean comfort · Add fried egg +$1.50 · Add cheese +$2",                              price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/kimchi-fried-rice.jpg",                    tags: ["spicy"] },
  ...
  { id: "doshirak", label: "Doshirak", emoji: "🍱", subtitle: "Korean set meals — includes rice & sides", items: [
    ...
    { name: "K-Doshirak Set (1 Protein)",       description: "Choice of 1 protein (beef bulgogi, spicy pork, spicy chicken, or K-pop chicken) — steamed rice, japchae · Add fried egg +$1.50", price: "$15.99", emoji: "🍱", image: "/images/menu/doshirak/beef-bulgogi-set.jpg", tags: [],              badge: "⭐ New" },
    { name: "K-Doshirak Set (2 Proteins)",      description: "Choice of 2 proteins (beef bulgogi, spicy pork, spicy chicken, or K-pop chicken) — steamed rice, kimchi, japchae, one side dish · Add fried egg +$1.50", price: "$17.99", emoji: "🍱", image: "/images/menu/doshirak/kdoshirak-set.jpg", tags: [],              badge: "⭐ New" },
    { name: "Donkatsu Set",                    description: "Panko-breaded pork cutlet, steamed rice, house kimchi, creamy coleslaw, tonkatsu sauce · Add fried egg +$1.50", price: "$21.99", emoji: "🍱", image: "/images/menu/doshirak/donkatsu.jpg",                             tags: [] },
    { name: "Tofu-Katsu Set",                  description: "Panko-breaded crispy tofu cutlet, steamed rice, creamy coleslaw, house kimchi, tonkatsu sauce · Add fried egg +$1.50", price: "$20.99", emoji: "🍱", image: "/images/menu/doshirak/tofu-katsu.png",                           tags: ["vegan"] },
  ...
  { id: "meals", label: "Meals", emoji: "🍽️", subtitle: "House favourites", items: [
    ...
    // ─ Hidden ─
    { name: "Veggie Tteokbokki",               description: "Rice cake with spicy & sweet gochujang sauce — vegan",                            price: "$12.99", emoji: "🍢", image: "/images/menu/signature/veggie-tteokbokki.png",                    tags: ["vegan","spicy"] },
  ]},
  ...
  { id: "appetizers", label: "Appetizers", emoji: "🥗", items: [
    ...
    { name: "French Fries",                    description: "Crispy golden fries",                                                            price: "$5.99",  emoji: "🍟", tags: ["vegan"],        badge: "⭐ New" },
  ...
  { id: "lunch-special", label: "Lunch Special", emoji: "🌞", subtitle: "Mon – Sat · 11 AM – 3 PM · Pickup only", items: [
    { name: "K-Lunch Box (Doshirak) — Combo 1", description: "K-pop Chicken & Gimbap with Yam & Salad · Add fried egg +$1.50",                                      price: "$9.99",  emoji: "🍱", image: "/images/menu/lunch-special/klunch-box-combo1.jpg",                tags: [],              badge: "🌞 Lunch Deal" },
    { name: "K-Lunch Box (Doshirak) — Combo 2", description: "K-pop Chicken & Fried Rice with Chicken Dumplings & Salad · Add fried egg +$1.50",                    price: "$9.99",  emoji: "🍱", image: "/images/menu/lunch-special/klunch-box-combo2.jpg",                tags: [],              badge: "🌞 Lunch Deal" },
    { name: "K-Lunch Box (Doshirak) — Combo 3", description: "K-pop Chicken & Japchae Noodle with Yam & Salad · Add fried egg +$1.50",                              price: "$9.99",  emoji: "🍱", image: "/images/menu/lunch-special/klunch-box-combo3.jpg",                tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Bibim Cupbap",                    description: "Beef bulgogi, carrot, cucumber & steamed rice tossed in sweet gochujang sauce — sesame seeds · Add fried egg +$1.50", price: "$12.99", emoji: "🥣", image: "/images/menu/lunch-special/bibim-cupbap.jpg",                      tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Dakgalbi Cupbap",                 description: "Spicy stir-fried chicken with rice cake, cabbage & green onion in gochujang sauce, over steamed rice · Add fried egg +$1.50 · Add cheese +$2", price: "$12.99", emoji: "🥣", image: "/images/menu/lunch-special/dakgalbi-cupbap.jpg",            tags: ["spicy"],       badge: "🌞 Lunch Deal" },
    { name: "Chicken Cupbap",                  description: "Chicken rice cup · Add fried egg +$1.50 · Add cheese +$2",                       price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Bulgogi Cupbap",                  description: "Bulgogi beef rice cup · Add fried egg +$1.50",                                    price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Crispy Chicken Cupbap",           description: "Crispy chicken rice cup · Add fried egg +$1.50 · Add cheese +$2",                                  price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Spicy Pork Cupbap",              description: "Spicy pork rice cup · Add fried egg +$1.50 · Add cheese +$2",                                      price: "$12.99", emoji: "🥣", tags: ["spicy"],        badge: "🌞 Lunch Deal" },
    { name: "Mushroom Cupbap",                description: "Mushroom & tofu rice cup · Add fried egg +$1.50",                                  price: "$12.99", emoji: "🥣", image: "/images/menu/rice-bowl/mushroom-tofu-deopbap.jpg",                 tags: ["vegan"],       badge: "🌞 Lunch Deal" },
    { name: "Japchae Cupbap",                  description: "Japchae noodle rice cup · Add fried egg +$1.50",                                  price: "$12.99", emoji: "🥣", tags: ["vegan"],        badge: "🌞 Lunch Deal" },
  ...
  { id: "platters", label: "Platters", emoji: "🎊", subtitle: "Great for groups! Order 24 hrs in advance.", items: [
    ...
    { name: "Kimbap Platter — Large",          description: "15 rolls, your choice — freshly made. Serves 10–15. Extra cost on selected rolls.", price: "$127.99", emoji: "🌯", image: "/images/menu/platters/large-rolls-platter.jpg", tags: [],             badge: "🍽️ Catering" },
    // ─ Dumpling Platters ─
    { name: "Dumpling Platter — Small",        description: "25 pcs mixed dumplings (chicken & veggie). Serves 3–4.",  price: "$23.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],             badge: "🍽️ Catering" },
    { name: "Dumpling Platter — Medium",       description: "50 pcs mixed dumplings (chicken & veggie). Serves 6–8.",  price: "$44.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],             badge: "🍽️ Catering" },
    { name: "Dumpling Platter — Large",        description: "100 pcs mixed dumplings (chicken & veggie). Serves 10–15.", price: "$84.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],            badge: "🍽️ Catering" },
    // ─ Chicken Platters ─
    { name: "Chicken Platter — Small",         description: "30 pcs K-Pop Chicken. Serves 3–4.",                       price: "$36.99",  emoji: "🍗", image: "/images/menu/signature/kpop-chicken-full.jpg",  tags: [],             badge: "🍽️ Catering" },
    { name: "Chicken Platter — Medium",        description: "60 pcs K-Pop Chicken. Serves 6–8.",                       price: "$68.99",  emoji: "🍗", image: "/images/menu/signature/kpop-chicken-full.jpg",  tags: [],             badge: "🍽️ Catering" },
    { name: "Chicken Platter — Large",         description: "100 pcs K-Pop Chicken. Serves 10–15.",                    price: "$107.99", emoji: "🍗", image: "/images/menu/signature/kpop-chicken-full.jpg",  tags: [],             badge: "🍽️ Catering" },
    // ─ Japchae Platters ─
    { name: "Japchae Platter — Half Tray",     description: "Glass noodles, carrot, peppers, mushroom. Serves ~2–3.",  price: "$35.99",  emoji: "🍜", image: "/images/menu/platters/mushroom-japchae.jpg",   tags: ["vegan","gf"], badge: "🍽️ Catering" },
    { name: "Japchae Platter — Full Tray",     description: "Glass noodles, carrot, peppers, mushroom. Serves ~5–6.",  price: "$67.99",  emoji: "🍜", image: "/images/menu/platters/mushroom-japchae.jpg",   tags: ["vegan","gf"], badge: "🍽️ Catering" },
    // ─ Party Packages ─
    { name: "Party Package — Small",           description: "For 10–15 people: Kimbap Platter S (5 rolls) + Dumpling Platter S (25 pcs) + Chicken Platter S (30 pcs)", price: "$102.99", emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    { name: "Party Package — Medium",          description: "For 20–30 people: Kimbap Platter M (10 rolls) + Chicken Platter M (60 pcs) + Dumpling Platter M (50 pcs) + Japchae Half Tray", price: "$222.99", emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    { name: "Party Package — Large",           description: "For 40–60 people: Kimbap Platter L (15 rolls) + Chicken Platter L (100 pcs) + Dumpling Platter L (100 pcs) + Japchae Full Tray", price: "$352.99", emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    // ─ Hidden ─
