...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "rice-bowl", label: "Rice Bowl", emoji: "🍚", subtitle: "Korean-style rice bowls", items: [
    ...
    { name: "Bulgogi Deopbap",                 description: "Thinly sliced sweet soy beef, onion, green onion over steamed rice — sesame oil, sesame seeds", price: "$14.99", emoji: "🥣", image: "/images/menu/deopbap/bulgogi-deopbap.png",                    tags: [] },
  ...
  { id: "platters", label: "Platters", emoji: "🎊", subtitle: "Great for groups! Order 24 hrs in advance.", items: [
    ...
    { name: "Large Rolls Platter",             description: "Choice of 7 kinds of rolls — serves 5–6. Extra cost on selected rolls.",         price: "$53.99", emoji: "🎊", image: "/images/menu/platters/large-rolls-platter.png",                tags: [],              badge: "🍽️ Catering" },
    ...
    { name: "Family Combo Set",                description: "K-pop chicken, KFC honey garlic (8 pcs), original gimbap, California roll, coleslaw, Crispy Tempura Mix", price: "$54.99", emoji: "🎉", image: "/images/menu/platters/family-combo-set.png",                   tags: [], badge: "👨‍👩‍👧 Family Deal" },
    // ─ Hidden ─
