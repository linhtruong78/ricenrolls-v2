...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "rice-bowl", label: "Rice Bowl", emoji: "🍚", subtitle: "Korean-style rice bowls", items: [
    ...
    { name: "Vegan Bibimbap",                  description: "Rice, carrots, seasonal herbs, cabbage, mushroom — gochujang sauce",              price: "$15.99", emoji: "🍚", image: "/images/menu/bibimbap/vegan-bibimbap.png",                       tags: ["vegan","gf"] },
    ...
    { name: "Kimchi Fried Rice",               description: "Rice, green onion, kimchi — classic Korean comfort",                              price: "$13.99", emoji: "🍳", image: "/images/menu/fried-rice/kimchi-fried-rice.png",                    tags: ["spicy"] },
    { name: "Signature Dakgalbi Deopbap",      description: "K-Spicy chicken over rice — chicken, onion, carrot, cabbage, lettuce, k-spicy sauce, sesame seeds", price: "$14.99", emoji: "🥣", image: "/images/menu/deopbap/kspicy-chicken-deopbap-main.png", tags: ["spicy"], badge: "🌶️ Signature" },
    { name: "Bulgogi Deopbap",                 description: "Thinly sliced sweet soy beef, onion, green onion over steamed rice — sesame oil, sesame seeds", price: "$14.99", emoji: "🥣", tags: [] },
    { name: "Spicy Pork Deopbap",              description: "Pork with spicy sauce, carrot, onion, cabbage, sesame seeds over rice",           price: "$14.99", emoji: "🥣", image: "/images/menu/deopbap/sweet-chilli-pork-deopbap.png",              tags: ["spicy"] },
    { name: "Mushroom Tofu Deopbap",           description: "Mushroom, tofu, onion, green onion, sesame seeds over steamed rice",              price: "$14.99", emoji: "🥣", image: "/images/menu/deopbap/mushroom-tofu-deopbap.png",                  tags: ["vegan"] },
  ...
  { id: "doshirak", label: "Doshirak", emoji: "🍱", subtitle: "Korean set meals — includes rice & sides", items: [
    { name: "Beef Bulgogi Set",                description: "Thinly sliced beef in sweet soy, garlic & sesame marinade — steamed rice, creamy coleslaw, sesame seeds, green onion", price: "$18.99", emoji: "🥩", image: "/images/menu/signature/beef-bulgogi-set.png", tags: [] },
    { name: "Spicy Pork Set",                  description: "Sliced pork with K-spicy sauce, onion, green onion, cabbage, rice",               price: "$18.99", emoji: "🐷", image: "/images/menu/signature/kspicy-pork-set.png",                      tags: ["spicy"] },
    { name: "K-Doshirak Set",                  description: "Bulgogi, K-pop chicken, kimchi, chicken dumplings, steamed rice, coleslaw",       price: "$20.99", emoji: "🍱", tags: [],              badge: "⭐ New" },
    { name: "Donkatsu Set",                    description: "Panko-breaded pork cutlet, steamed rice, house kimchi, creamy coleslaw, tonkatsu sauce", price: "$21.99", emoji: "🍱", image: "/images/menu/signature/donkatsu.png",                             tags: [] },
    ...
    { name: "K-BBQ Box Set",                   description: "Bulgogi or K-spicy chicken, rice, fresh veggies, K-samjang sauce",                price: "$29.99", emoji: "🥡", image: "/images/menu/signature/kdinner-box.png",                         tags: [] },
    ...
    // ─ Hidden ─
    { name: "K-Spicy Chicken Set",             description: "Rice, chicken, rice cake with Korean spicy sauce, coleslaw",                      price: "$18.99", emoji: "🌶️", image: "/images/menu/signature/kspicy-chicken-set.png",                   tags: ["spicy"],       hidden: true },
  ...
  { id: "gimbap-rolls", label: "Gimbap & Rolls", emoji: "🌯", subtitle: "8–10 pcs · housemade sauces", items: [
    ...
    { name: "Crispy Veggie",                   description: "Crispy onion, carrot, red sweet pepper, yam, cucumber",                           price: "$10.99", emoji: "🌯", image: "/images/menu/gimbap/crispy-veggie-roll.png",                      tags: ["vegan"] },
    { name: "Bulgogi Beef",                    description: "Beef bulgogi, carrot, lettuce",                                                   price: "$11.99", emoji: "🌯", image: "/images/menu/gimbap/beef-bulgogi-gimbap.png",                     tags: [],              badge: "⭐ Best Seller" },
    ...
    { name: "Yam Roll (6 pcs)",                description: "Golden crispy deep-fried sweet yam, seasoned sushi rice, toasted nori",          price: "$6.99",  emoji: "🌯", image: "/images/menu/gimbap/yam-roll.png",                                tags: ["vegan"] },
    { name: "Cucumber Roll",                   description: "Cool crisp cucumber, seasoned sushi rice, toasted nori, sesame seeds",           price: "$6.99",  emoji: "🥒", tags: ["vegan"] },
    { name: "Shrimp Tempura Roll",             description: "Crispy shrimp tempura roll",                                                      price: "Soon!",  emoji: "🦐", tags: [],              comingSoon: true },
    // ─ Hidden ─
    { name: "Tuna",                            description: "Canned tuna, carrot, cucumber, lettuce, egg, chilli pepper, crab meat",           price: "$11.99", emoji: "🌯", image: "/images/menu/gimbap/tuna-gimbap.png",                             tags: [],              hidden: true },
  ...
  { id: "meals", label: "Meals", emoji: "🍽️", subtitle: "House favourites", items: [
    ...
    { name: "KFC Wings (6 pcs)",               description: "Crispy Korean fried chicken wings — K-pop sauce or mild soya honey",              price: "$10.99", emoji: "🍗", image: "/images/menu/signature/kfc-wings.png",                            tags: [] },
    { name: "K-Spicy Chicken",                 description: "Rice, chicken, rice cake with Korean spicy sauce, coleslaw",                      price: "$18.99", emoji: "🌶️", image: "/images/menu/signature/kspicy-chicken-set.png",                   tags: ["spicy"] },
  ...
  { id: "appetizers", label: "Appetizers", emoji: "🥗", items: [
    ...
    { name: "Crispy Tofu",                     description: "Golden crispy fried tofu cubes, served with soy-vinegar dipping sauce & green onion", price: "$8.99",  emoji: "🟨", image: "/images/menu/appetizers/crispy-tofu.png",                         tags: ["vegan"] },
    { name: "Chicken Dumplings",               description: "Handmade dumplings — ground chicken, cabbage, garlic, ginger, green onion & sesame oil, pan-fried golden", price: "$8.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.png",                   tags: [] },
    { name: "Veggie Dumplings",                description: "Handmade dumplings — cabbage, glass noodles, tofu, garlic, sesame oil & ginger, pan-fried golden", price: "$8.99",  emoji: "🥟", image: "/images/menu/appetizers/veggie-dumplings.png",                    tags: ["vegan"] },
    { name: "Kimchi Pancake",                  description: "Crispy savoury jeon — fermented kimchi, green onion & savoury batter, served with soy-vinegar dipping sauce", price: "$12.99", emoji: "🥞", tags: ["spicy"],        badge: "⭐ New" },
    { name: "Crispy Veggie Tempura",           description: "3 yam, 1 broccoli, 2 zucchini & 2 onion rings — lightly battered & fried, served with dipping sauce", price: "$9.99",  emoji: "🍤", tags: ["vegan"],        badge: "⭐ New" },
  ...
  { id: "lunch-special", label: "Lunch Special", emoji: "🌞", subtitle: "Mon – Sat · 11 AM – 2 PM · Pickup only", items: [
    { name: "K-Lunch Box (Doshirak) — Combo 1", description: "K-pop Chicken & Gimbap with Yam & Salad",                                      price: "$9.99",  emoji: "🍱", image: "/images/menu/lunch-special/klunch-box-combo1.png",                tags: [],              badge: "🌞 Lunch Deal" },
    { name: "K-Lunch Box (Doshirak) — Combo 2", description: "K-pop Chicken & Fried Rice with Chicken Dumplings & Salad",                    price: "$9.99",  emoji: "🍱", image: "/images/menu/lunch-special/klunch-box-combo2.png",                tags: [],              badge: "🌞 Lunch Deal" },
  ...
  { id: "platters", label: "Platters", emoji: "🎊", subtitle: "Great for groups! Order 24 hrs in advance.", items: [
    { name: "Rolls Platter",                   description: "Choice of 5 kinds of rolls — serves 3–4. Extra cost on selected rolls.",         price: "$38.99", emoji: "🎊", image: "/images/menu/platters/rnr-platter.png",                           tags: [],              badge: "🍽️ Catering" },
    { name: "Large Rolls Platter",             description: "Choice of 7 kinds of rolls — serves 5–6. Extra cost on selected rolls.",         price: "$53.99", emoji: "🎊", tags: [],              badge: "🍽️ Catering" },
    ...
    { name: "Family Combo Set",                description: "K-pop chicken, KFC honey garlic (8 pcs), original gimbap, California roll, coleslaw, Crispy Tempura Mix", price: "$54.99", emoji: "🎉", tags: [], badge: "👨‍👩‍👧 Family Deal" },
    // ─ Hidden ─
