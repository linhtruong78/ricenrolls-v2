...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "rice-bowl", label: "Rice Bowl", emoji: "🍚", subtitle: "Korean-style rice bowls", items: [
    ...
    { name: "Signature Dakgalbi Deopbap",      description: "K-Spicy chicken over rice — chicken, onion, carrot, cabbage, lettuce, k-spicy sauce, sesame seeds", price: "$14.99", emoji: "🥣", image: "/images/menu/rice-bowl/kspicy-chicken-deopbap-main.jpg", tags: ["spicy"], badge: "🌶️ Signature" },
    { name: "Bulgogi Deopbap",                 description: "Thinly sliced sweet soy beef, onion, green onion over steamed rice — sesame oil, sesame seeds", price: "$14.99", emoji: "🥣", image: "/images/menu/rice-bowl/bulgogi-deopbap.jpg",                    tags: [] },
    { name: "Spicy Pork Deopbap",              description: "Pork with spicy sauce, carrot, onion, cabbage, sesame seeds over rice",           price: "$14.99", emoji: "🥣", image: "/images/menu/rice-bowl/sweet-chilli-pork-deopbap.jpg",              tags: ["spicy"] },
    { name: "Mushroom Tofu Deopbap",           description: "Mushroom, tofu, onion, green onion, sesame seeds over steamed rice",              price: "$14.99", emoji: "🥣", image: "/images/menu/rice-bowl/mushroom-tofu-deopbap.jpg",                  tags: ["vegan"] },
  ...
  { id: "doshirak", label: "Doshirak", emoji: "🍱", subtitle: "Korean set meals — includes rice & sides", items: [
    { name: "Beef Bulgogi Set",                description: "Thinly sliced beef in sweet soy, garlic & sesame marinade — steamed rice, creamy coleslaw, sesame seeds, green onion", price: "$18.99", emoji: "🥩", image: "/images/menu/doshirak/beef-bulgogi-set.jpg", tags: [] },
    { name: "Spicy Pork Set",                  description: "Sliced pork with K-spicy sauce, onion, green onion, cabbage, rice",               price: "$18.99", emoji: "🐷", image: "/images/menu/doshirak/kspicy-pork-set.jpg",                      tags: ["spicy"] },
  ...
  { id: "platters", label: "Platters", emoji: "🎊", subtitle: "Great for groups! Order 24 hrs in advance.", items: [
    ...
    { name: "Vegan Platter",                   description: "38 pcs dairy & egg-free — serves 3–4",                                           price: "$42.99", emoji: "🌿", image: "/images/menu/platters/vegan-platter-med.jpg",                     tags: ["vegan"] },
