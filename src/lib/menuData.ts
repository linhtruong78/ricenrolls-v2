...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "platters", label: "Platters", emoji: "🎊", subtitle: "Great for groups! Order 24 hrs in advance.", items: [
    ...
    // ─ Dumpling Platters ─
    { name: "Dumpling Platter — Small",        description: "25 pcs mixed dumplings (chicken & veggie). Serves 3–4.",  price: "$21.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],             badge: "🍽️ Catering" },
    { name: "Dumpling Platter — Medium",       description: "50 pcs mixed dumplings (chicken & veggie). Serves 6–8.",  price: "$41.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],             badge: "🍽️ Catering" },
    { name: "Dumpling Platter — Large",        description: "100 pcs mixed dumplings (chicken & veggie). Serves 10–15.", price: "$81.99",  emoji: "🥟", image: "/images/menu/appetizers/chicken-dumplings.jpg", tags: [],            badge: "🍽️ Catering" },
    // ─ Chicken Platters ─
    ...
    // ─ Party Packages ─
    { name: "Party Package — Small",           description: "For 10–15 people: Kimbap Platter S (5 rolls) + Dumpling Platter S (25 pcs) + Chicken Platter S (30 pcs)", price: "$97.97",  emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    { name: "Party Package — Medium",          description: "For 20–30 people: Kimbap Platter M (10 rolls) + Chicken Platter M (60 pcs) + Dumpling Platter M (50 pcs) + Japchae Half Tray", price: "$220.96", emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    { name: "Party Package — Large",           description: "For 40–60 people: Kimbap Platter L (15 rolls) + Chicken Platter L (100 pcs) + Dumpling Platter L (100 pcs) + Japchae Full Tray", price: "$369.96", emoji: "🎉", image: "/images/menu/platters/catering-pizza-box.png", tags: [], badge: "🎊 Party Deal" },
    // ─ Hidden ─
