...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "lunch-special", label: "Lunch Special", emoji: "🌞", subtitle: "Mon – Sat · 11 AM – 3 PM · Pickup only", items: [
    ...
    { name: "Bulgogi Cupbap",                  description: "Bulgogi beef rice cup · Add fried egg +$1.50",                                    price: "$12.99", emoji: "🥣", image: "/images/menu/rice-bowl/bulgogi-deopbap.jpg",                   tags: [],              badge: "🌞 Lunch Deal" },
    ...
    { name: "Spicy Pork Cupbap",              description: "Spicy pork rice cup · Add fried egg +$1.50 · Add cheese +$2",                                      price: "$12.99", emoji: "🥣", image: "/images/menu/rice-bowl/sweet-chilli-pork-deopbap.jpg",         tags: ["spicy"],        badge: "🌞 Lunch Deal" },
