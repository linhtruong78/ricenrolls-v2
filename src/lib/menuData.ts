...
export const menuCategories: MenuCategory[] = [
  ...
  { id: "rice-bowl", label: "Rice Bowl", emoji: "🍚", subtitle: "Korean-style rice bowls", items: [
    ...
    { name: "Chicken Fried Rice",              description: "Rice, peas, carrot, green bean, green onion, chicken · Add fried egg +$1.50",                            price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/chicken-fried-rice.jpg",                   tags: [] },
    ...
    { name: "Beef Fried Rice",                 description: "Rice, peas, carrot, green bean, green onion, beef · Add fried egg +$1.50",                               price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/beef-fried-rice.jpg",                      tags: [] },
    { name: "Kimchi Fried Rice",               description: "Rice, green onion, kimchi — classic Korean comfort · Add fried egg +$1.50",                              price: "$13.99", emoji: "🍳", image: "/images/menu/rice-bowl/kimchi-fried-rice.jpg",                    tags: ["spicy"] },
  ...
  { id: "lunch-special", label: "Lunch Special", emoji: "🌞", subtitle: "Mon – Sat · 11 AM – 3 PM · Pickup only", items: [
    ...
    { name: "Dakgalbi Cupbap",                 description: "Spicy stir-fried chicken with rice cake, cabbage & green onion in gochujang sauce, over steamed rice · Add fried egg +$1.50", price: "$12.99", emoji: "🥣", image: "/images/menu/lunch-special/dakgalbi-cupbap.jpg",            tags: ["spicy"],       badge: "🌞 Lunch Deal" },
    { name: "Chicken Cupbap",                  description: "Chicken rice cup · Add fried egg +$1.50",                                        price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Bulgogi Cupbap",                  description: "Bulgogi beef rice cup · Add fried egg +$1.50",                                    price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Crispy Chicken Cupbap",           description: "Crispy chicken rice cup · Add fried egg +$1.50",                                  price: "$12.99", emoji: "🥣", tags: [],              badge: "🌞 Lunch Deal" },
    { name: "Spicy Pork Cupbap",              description: "Spicy pork rice cup · Add fried egg +$1.50",                                      price: "$12.99", emoji: "🥣", tags: ["spicy"],        badge: "🌞 Lunch Deal" },
